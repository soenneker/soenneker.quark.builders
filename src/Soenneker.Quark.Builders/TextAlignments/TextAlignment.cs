...
public static class TextAlignment
{
    ...
    /// </summary>
    public static TextAlignmentBuilder Start => new(TextAlignmentEnum.Start);

    /// <summary>
    /// Gets a text alignment builder with center value (text is centered).
    /// </summary>
    public static TextAlignmentBuilder Center => new(TextAlignmentEnum.Center);

    /// <summary>
    /// Gets a text alignment builder with end value (right in LTR, left in RTL).
    /// </summary>
    public static TextAlignmentBuilder End => new(TextAlignmentEnum.End);
}
