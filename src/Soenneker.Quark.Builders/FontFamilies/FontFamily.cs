...
public static partial class FontFamily
{
    ...
    /// </summary>
    public static FontFamilyBuilder Sans => new(FontFamilyEnum.SansValue);
    /// <summary>
    ...
    /// </summary>
    public static FontFamilyBuilder Serif => new(FontFamilyEnum.SerifValue);
    /// <summary>
    ...
    /// </summary>
    public static FontFamilyBuilder Mono => new(FontFamilyEnum.MonoValue);
}
