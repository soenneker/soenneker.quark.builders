...
public sealed class OutlineOffsetBuilder : ResponsiveUtilityBuilder<OutlineOffsetBuilder>
{
    ...
    public OutlineOffsetBuilder Is0 => ChainValue(OutlineOffsetEnum.Is0.Value);
    public OutlineOffsetBuilder Is1 => ChainValue(OutlineOffsetEnum.Is1.Value);
    public OutlineOffsetBuilder Is2 => ChainValue(OutlineOffsetEnum.Is2.Value);
    public OutlineOffsetBuilder Is4 => ChainValue(OutlineOffsetEnum.Is4.Value);
    public OutlineOffsetBuilder Is8 => ChainValue(OutlineOffsetEnum.Is8.Value);
