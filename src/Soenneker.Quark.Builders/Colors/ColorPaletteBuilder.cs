...
public sealed class ColorPaletteBuilder<TBuilder>
{
    ...
    internal ColorPaletteBuilder(string palette, Func<string, TBuilder> create)
    {
        _palette = palette;
        _create = create;
    }

    internal ColorPaletteBuilder(string palette, IColorTokenFactory<TBuilder> create)
    {
        _palette = palette;
        _create = create;
    }
